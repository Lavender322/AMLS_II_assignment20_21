...
class DIV2K:
    def __init__(self,
        ...
        if subset == 'train':
            ...
            self.image_ids = range(801, 811)
        elif subset == 'test':
            self.image_ids = range(811, 901)
        else:
    ...
    def _hr_images_dir(self):
        if self.subset == 'test':
            return os.path.join(self.images_dir, f'DIV2K_valid_HR')
        return os.path.join(self.images_dir, f'DIV2K_{self.subset}_HR')

    def _lr_images_dir(self):
        if self.subset == 'test':
            return os.path.join(self.images_dir, f'DIV2K_valid_LR_{self.downgrade}', f'X{self.scale}')
