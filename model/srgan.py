...
from model.shared import pixel_shuffle, normalize_01, normalize_m11, denormalize_m11
    
    
HR_SIZE = 96


def upsample(x_in, factor, num_filters):
...
def sr_resnet(num_filters=64, scale=4, num_res_blocks=16):
    ...
    if scale == 2:
        x = upsample(x, 2, num_filters * 4, name='conv2d_1_scale_2')
    elif scale == 3:
        x = upsample(x, 3, num_filters * 9, name='conv2d_1_scale_3')
    elif scale == 4:
        x = upsample(x, 2, num_filters * 4, name='conv2d_1_scale_2')
        x = upsample(x, 2, num_filters * 4, name='conv2d_1_scale_2')
